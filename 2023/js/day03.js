...
schematicArray.forEach((line, i) => {
  ...
  entries.forEach((entry, j) => {
    ...
    if (entry.match(/\d/)) {  
      ...
      // If the entry is not a number, check if the buffer has any numbers in it. If it does, join the numbers in the buffer and push them to the partNumbers array.
      let adjSymbols = false;
