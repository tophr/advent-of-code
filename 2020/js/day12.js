const instructionsEx = `F10
N3
F7
R90
F11`;

const instructions = `N2
R90
S2
F40
R180
...
instructionsArray.forEach((instruction, i) => {
  instructionsArray[i] = [instruction.slice(0, 1), instruction.slice(1)];
});
console.log(instructionsArray);

function navigation( instructions ) {
  let x = 0; //EW
  let y = 0; //NS
  let heading = 90;
  instructions.forEach((instruction, i) => {
    if ( instruction[0] == 'N' ) {
      ...
      heading += -parseInt(instruction[1]);
      heading = heading % 360;
